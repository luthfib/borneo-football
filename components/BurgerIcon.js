...
const MenuItemAStyled = styled.a`
  ...
  :hover {
    background-color: rgba(22,0,18, .1);
  }
    ...
    render() {
        return (
            <HeaderStyled style={{ backgroundColor: this.state.bgColor }} >
                <MenuBtnStyled type="checkbox" checked={this.state.checked} onChange={this.changeVisibility} id={MenuBtnStyled} onClick={this.onChange}></MenuBtnStyled>
                ...
                <MenuStyled>
                    ...
                    <ListStyled onClick={this.changeVisibility}>
                        <MenuItemAStyled href="#GetInvolved"> GET INVOLVED </MenuItemAStyled>
                    </ListStyled>
                    <ListStyled onClick={this.changeVisibility}>
